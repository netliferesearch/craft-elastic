...
namespace dfo\craftelastic\widgets;

use dfo\craftelastic\CraftElastic;
use dfo\craftelastic\assetbundles\craftelasticwidgetwidget\CraftElasticWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Craft Elastic Widget
 *
 ...
 * @since     1.0.0
 */
class CraftElasticWidget extends Widget
{
    ...
    {
        return Craft::t('craftelastic', 'CraftElasticWidget');
    }
    ...
    {
        return Craft::getAlias("@dfo/craftelastic/assetbundles/craftelasticwidgetwidget/dist/img/CraftElasticWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'craftElastic/_components/widgets/CraftElasticWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CraftElasticWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'craftelastic/_components/widgets/CraftElasticWidget_body',
            [
